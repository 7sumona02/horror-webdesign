...
function PrizeCard() {
  return (
    <>
      <div className="w-[350px] relative mt-4 h-[350px] group mx-auto dark:bg-black  bg-white dark:border-0 border rounded-md dark:text-white text-black flex flex-col">
        ...
        <article className="relative overflow-hidden  flex-grow">
          ...
          <button className="absolute h-10 -bottom-8 opacity-0 group-hover:opacity-100 cursor-pointer group-hover:bottom-3  text-2xl font-medium transition-all duration-300 w-full text-center text-[#ff7940]">
            CEO &amp; Design Engineer
          </button>
        </article>
      </div>
